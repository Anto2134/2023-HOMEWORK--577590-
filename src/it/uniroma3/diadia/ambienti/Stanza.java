...
public class Stanza {
	...
	public boolean addAttrezzo(Attrezzo attrezzo) {
		if(nome2attrezzo.size() >= Stanza.NUMERO_MASSIMO_ATTREZZI)
			return false;
	...
	public boolean equals(Object o) {
		...
		return that.getDescrizione().equals(this.getDescrizione()) &&
				that.getMapStanzeAdiacenti().equals(this.getMapStanzeAdiacenti()) &&
				that.getDirezioni().equals(this.getDirezioni())
				&& that.getNome().equals(this.getNome());
	}
