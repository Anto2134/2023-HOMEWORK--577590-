...
public class LabirintoBuilderTest2 {
	...
	private Direzione sud = Direzione.SUD;
	private Direzione est = Direzione.EST;
	private Direzione ovest = Direzione.OVEST;
	...
	public void testMonolocaleConAttrezzoSingoloDuplicato() {
		...
		//assertEquals(Collections.singleton(new Attrezzo("spada",1)), monolocale.getStanzaIniziale().getAttrezzi());
		assertEquals("spada",monolocale.getStanzaIniziale().getAttrezzo("spada").getNome());
	}
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertNotNull(this.labirintoBuilder.getListaStanze().get(nomeStanza).getAttrezzi().contains(new Attrezzo (nomeAttrezzo,peso)));
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		assertNotNull(attrezzi.contains(attrezzo));
	}
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		...
		stanzaVincente.impostaStanzaAdiacente(sud, labirintoBuilder.getListaStanze().get("stanza bloccata"));
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		stanzaBloccata.impostaStanzaAdiacente(sud, labirintoBuilder.getListaStanze().get(nomeStanzaIniziale));
		stanzaBloccata.impostaStanzaAdiacente(nord, labirintoBuilder.getListaStanze().get(nomeStanzaVincente));
